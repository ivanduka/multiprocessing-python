...
def extract_table(argument_list):
    ...
    try:
        ...
        for ind, page in enumerate(pages):
            ...
            try:
                tables = camelot.read_pdf(file_path, pages=str(pg_num + 1), flag_size=True, copy_text=['v'],
            ...
            # in case only one table is present on the page,
                ...
                if len(title_lst) == 0:
                    ...
                    if (pg_num - 1 in title_dict):
                        ...
                        if (len((set(lst_tbl_df.columns)).difference(set(df_tb.columns))) == 0) or (
                                len(set(lst_tbl_df.columns)) == len(set(df_tb.columns))) or (ratio_similarity > 89):
                            xl_name = lst_tbl[2]
                ...
                if len(title_lst) >= tb_num:
                    ...
                    try:
                        ...
                        if (pg_num - 1 in title_dict):
                            ...
                            if len((set(lst_tbl_df.columns)).difference(set(df_tb.columns))) == 0 or len(
                                    set(lst_tbl_df.columns)) == len(set(df_tb.columns)) or ratio_similarity > 89:
                                xl_name = lst_tbl[2]
                                chars.append([0, df_tb, xl_name])
                                xlsx_name = file_name + '_' + xl_name + '_' + str(pg_num + 1) + '_' + str(1) + '.csv'
                                df_tb.to_csv(xlsx_name, index=False, encoding='utf-8-sig')
...
df = pd.read_csv(path,
                 usecols=['page_number', 'final_table_title', 'Application title short', 'DataID_pdf', 'categories',
                          'Category'])
...
files = ['2968357.pdf', '2968358.pdf', '2968365.pdf', '2968366.pdf', '2968367.pdf', '2968368.pdf', '2968370.pdf',
         '2968373.pdf', '2968377.pdf', '2968378.pdf', '2968379.pdf', '2968380.pdf', '2968417.pdf', '2968421.pdf',
         '2968422.pdf', '2968425.pdf', '2968426.pdf', '2968427.pdf', '2968430.pdf', '2968431.pdf', '2968432.pdf',
         '2968434.pdf', '2968436.pdf', '2968440.pdf', '2968448.pdf', '2968450.pdf', '2968452.pdf', '2968457.pdf',
         '2968458.pdf', '2968462.pdf', '2968464.pdf', '2968467.pdf', '2968468.pdf', '2968470.pdf', '2968475.pdf',
         '2968476.pdf', '2968477.pdf', '2968478.pdf', '2968479.pdf', '2968480.pdf', '2969255.pdf', '2969256.pdf',
         '2969257.pdf', '2969269.pdf', '2969272.pdf', '2969283.pdf', '2969358.pdf', '2969359.pdf', '2969375.pdf',
         '2969376.pdf', '2969377.pdf', '2969378.pdf', '2969379.pdf', '2969456.pdf', '2969457.pdf', '2969460.pdf',
         '2969462.pdf', '2969464.pdf', '2969466.pdf', '2969469.pdf', '2969470.pdf', '2969473.pdf', '2969475.pdf',
         '2969476.pdf', '2969477.pdf', '2969479.pdf', '2969480.pdf', '2969481.pdf', '2969496.pdf', '2969497.pdf',
         '2969557.pdf', '2969564.pdf', '2969567.pdf', '2969569.pdf', '2969570.pdf', '2969571.pdf', '2969586.pdf',
         '2969587.pdf', '2969659.pdf', '2969663.pdf', '2969665.pdf', '2969666.pdf', '2969674.pdf', '2969675.pdf',
         '2969678.pdf', '2969679.pdf', '2969680.pdf', '2969688.pdf', '2969689.pdf', '2969759.pdf', '2969763.pdf',
         '2969765.pdf', '2969766.pdf', '2969767.pdf', '2969780.pdf', '2969781.pdf', '2969782.pdf', '2969783.pdf',
         '2969865.pdf', '2969866.pdf', '2969880.pdf', '2969881.pdf', '2969882.pdf', '2969968.pdf', '2969969.pdf',
         '2969970.pdf']
